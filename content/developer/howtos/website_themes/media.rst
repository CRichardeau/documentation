...
reuse them), you need to declare them like this:
...
In your xml templates, you can call your images as follows:
...
For the company logo, the use is a little bit different. First you have to declare it within the
`images.xml` library and then you will have to call it using the right template. For instnace, to
call it in the header, we will use `<t t-call="website.placeholder_header_brand">`.
