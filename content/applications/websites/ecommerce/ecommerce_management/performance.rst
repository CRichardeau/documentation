...
#. Go to :menuselection:`Settings --> Technical --> Automation --> Scheduled Actions` and enable the
...
.. caution::
   ...
   recommended only for high-traffic websites, as it can introduce unnecessary delays for eCommerces
