...
.. tip::
  The pivot view is also be useful for this version of the report.
...
periods with higher |SLA| breaches. This helps to highlight trends in |SLA| compliance, allowing for
proactive measures during periods prone to |SLA| breaches.
...
.. note::
   While the :guilabel:`SLA Status Analasis` report defaults to the pivot view, the line chart view
   provides a better visual representation for this specific use case.

Click :guilabel:`Measures`, then select :guilabel:`Number of SLAs Failed`. Click into the search
bar, then under :guilabel:`Group By`, select :guilabel:`SLA Deadline`, and select a time frame,
either :guilabel:`Month`, :guilabel:`Week`, or :guilabel:`Day`.
